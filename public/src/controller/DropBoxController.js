class DropBoxController {
  ...
  connectFirebase() {
    const firebaseConfig = {
      apiKey: "AIzaSyA9aSfczWbCC9NTS9StvkcJVWKVPCSKfog",
      authDomain: "dropboxclone-c610a.firebaseapp.com",
      databaseURL: "https://dropboxclone-c610a-default-rtdb.firebaseio.com",
      projectId: "dropboxclone-c610a",
      storageBucket: "dropboxclone-c610a.appspot.com",
      messagingSenderId: "1056135197423",
      appId: "1:1056135197423:web:b9aaebd918ed0ab476a11a",
      measurementId: "G-E97H5GLJ7F"
    };
      ...
      folderRef.on('value', snapshot =>{
        ...
        snapshot.forEach(item =>{
          ...
          if(data.type === 'folder'){
            ...
            this.getFirebaseRef(ref + '/' + name, data.name).then(()=>{
  ...
  removeFile(ref, name) {
    ...
    let fireref = firebase.storage().ref(ref).child(name);

    return fireref.delete();
  ...
  initEvents() {
    ...
    this.btnNewFolder.addEventListener('click', e => {
      ...
      let name = prompt('Insira o nome da nova pasta: ');
